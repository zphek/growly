...
const Home = () => {
    return (<div className="h-full w-ful">
        <div className="h-[90vh] overflow-hidden flex flex-col xs:flex-col items-center justify-center space-x-7 cover relative">
            <div className='h-[90vh] overflow-hidden flex flex-col xs:flex-col items-center justify-center space-x-7 z-20'>
                <h2 className="font-abgalumo italic text-4xl lg:text-6xl font-bold mb-2 text-blue-500">Growly</h2>
                <h3 className="text-white text-2xl lg:text-5xl font-bold text-center">EL LUGAR DONDE LOS SUEÑOS DESPIERTAN</h3>
                <h2 className="text'white text-xl text-center lg:text-4xl text-white mt-3">¡Únete ahora y forma parte una plataforma como esta!</h2>
            ...
            <div className="absolute w-[100vw] inset-0 bg-black opacity-50 z-10"></div>
        </div>
        ...
        <div className="bg-white py-16">
            ...
            <div className="container flex flex-row items-center justify-center gap-x-20 gap-y-10 text-center text-lg lg:text-xl flex-wrap mt-5">
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h2 className="font-bold">BENJAMIN AVIRON</h2>
                    <h4>QA</h4>
                </div>
